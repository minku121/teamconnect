...
export default function Footer() {
  return (
    <div>
        <footer className="w-full py-8 px-4 bg-gray-100 dark:bg-[#0a0a0a]">
<div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center">
  <div className="w-full md:w-1/3 mb-6 md:mb-0">
    ...
    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
      Connecting teams, fostering collaboration.
    </p>
  </div>
  <div className="w-full md:w-1/3 mb-6 md:mb-0">
    ...
    <ul className="space-y-2">
      ...
      <li>
        <Link href="/teams" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
          Teams
        </Link>
      </li>
      <li>
...
<div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 text-center text-sm text-gray-600 dark:text-gray-400">
  © {new Date().getFullYear()} TeamConnect. All rights reserved.
</div>
</footer>
    </div>
  )
